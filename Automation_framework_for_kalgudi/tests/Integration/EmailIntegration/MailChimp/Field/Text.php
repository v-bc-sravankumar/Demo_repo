...
class Unit_EmailIntegration_MailChimp_Field_Text extends Unit_EmailIntegration_MailChimp_Field_Base
{
	public $providerFieldClassName = 'Interspire_EmailIntegration_MailChimp_Field_Text';
