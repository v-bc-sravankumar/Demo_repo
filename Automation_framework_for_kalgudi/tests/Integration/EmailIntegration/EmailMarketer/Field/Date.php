...
class Unit_EmailIntegration_EmailMarketer_Field_Date extends Unit_EmailIntegration_EmailMarketer_Field_Base
{
	public $providerFieldClassName = 'Interspire_EmailIntegration_EmailMarketer_Field_Date';
	...
	*/
	public function dataProviderFromSubscriptionToProvider ()
	{
		$data = array(
			...
			array(new Interspire_EmailIntegration_Field_Date, 1273025038, '5/5/2010'),
			array(new Interspire_EmailIntegration_Field_Date, '2010-12-31', '31/12/2010'),
