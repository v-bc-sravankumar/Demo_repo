...
class Unit_EmailIntegration_EmailMarketer_Field_Text extends Unit_EmailIntegration_EmailMarketer_Field_Base
{
	public $providerFieldClassName = 'Interspire_EmailIntegration_EmailMarketer_Field_Text';
